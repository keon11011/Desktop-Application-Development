...
namespace DTO_TaiKhoan
{
    public class TaiKhoan
    {
        ...
        public TaiKhoan(string maTK, string emailTK, string matKhauTK, string maHashTK, string maSaltTK, string trangThaiTK, string maNV, DateTime taoVaoLuc, string taoBoi, DateTime chinhSuaLanCuoiVaoLuc, string chinhSuaLanCuoiBoi)
        {
            MaTK = maTK;
            EmailTK = emailTK;
            MatKhauTK = matKhauTK;
