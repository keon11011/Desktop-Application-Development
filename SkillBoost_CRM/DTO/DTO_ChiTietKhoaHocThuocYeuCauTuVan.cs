...
namespace DTO
{
    public class DTO_ChiTietKhoaHocThuocYCTV
    {
        ...
        public string MaBaoGia { get => _maTuVan; set => _maTuVan = value; }
        ...
        public DTO_ChiTietKhoaHocThuocYCTV(string maBaoGia, string maKhoaHoc, string tenKhoaHoc, string giangVien, float giaTien)
        {
            MaBaoGia = maBaoGia;
            MaKhoaHoc = maKhoaHoc;
