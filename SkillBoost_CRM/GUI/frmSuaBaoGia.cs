...
namespace GUI
{
    public partial class frmSuaBaoGia : Form
    {
        ...
        {
            // Báo giá của ai?
            txtBaoGiaCuaLead.Text = SharedResources.TenLead; // Fix cứng
            newLead.MaLead = SharedResources.MaLead; // Fix cứng

            // MaBaoGia có mã giảm giá
            // txtMaBaoGia.Text = "QUO20"; // Fix cứng
            // MaBaoGia không có mã giảm giá
            txtMaBaoGia.Text = SharedResources.MaBaoGia; // Fix cứng
            khThuocBaoGia.MaBaoGia = SharedResources.MaBaoGia; // Fix cứng
            txtTenBaoGia.Text = SharedResources.TenBaoGia; // Fix cứng

            txtTongTienTrcGiam.Text = SharedResources.TongTienTrcGiam;
            txtSoTienGiamGia.Text = SharedResources.SoTienGiamGia;
            txtThanhTien.Text = SharedResources.ThanhTien;
            ...
            txtTrangThaiEmailBaoGia.Text = SharedResources.TrangThaiBaoGia; // fix cứng
            if (txtTrangThaiEmailBaoGia.Text == "Đã gửi mail")
            {
            ...
            else
            {
                ...
                txtTongTienTrcGiam.Enabled = false;
                txtThanhTien.Enabled = false;
                txtSoTienGiamGia.Enabled = false;
            }
        }
        ...
        private void btnLuuSuaBaoGia_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    newBaoGia.TongTien = float.Parse(txtThanhTien.Text);
                    if (txtTrangThaiEmailBaoGia.Text == null)
                    {
                        newBaoGia.TrangThaiBaoGia = "Chưa thanh toán"; // Fix cứng
                    }
                    else
                    {
                        newBaoGia.TrangThaiBaoGia = txtTrangThaiEmailBaoGia.Text;
                    }
        ...
        private void btnGuiEmailBaoGia_Click(object sender, EventArgs e)
        {
            ...
            txtTrangThaiEmailBaoGia.Text = "Đã gửi mail";


            newBaoGia.MaBaoGia = txtMaBaoGia.Text;
            newBaoGia.TrangThaiBaoGia = "Đã gửi mail"; // Fix cứng
        ...
        private void btnTaoEmailBaoGia_Click(object sender, EventArgs e)
        {
            ...
            newBaoGia.TrangThaiBaoGia = "Đã soạn mail nháp"; // Fix cứng
